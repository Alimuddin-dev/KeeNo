                ...
                else
                {
                    ...
                    firebaseAuth.sendPasswordResetEmail(mail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            {
                                Toast.makeText(getApplicationContext(),"Email Terkirim, Anda dapat memulihkan kata sandi Anda menggunakan email",Toast.LENGTH_SHORT).show();
                                finish();
                                startActivity(new Intent(fogotpassword.this,MainActivity.class));
                            }
                            else
                            {
                                Toast.makeText(getApplicationContext(),"Email salah, akun tidak ada",Toast.LENGTH_SHORT).show();
                            }
